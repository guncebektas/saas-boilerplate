...
import {faHouse, faMugSaucer, faQrcode, faBagShopping, faUser } from '@fortawesome/free-solid-svg-icons';

export const NavMobile = () => {
  return (
    <Navbar className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 sm:hidden">
      <ul className="flex justify-between w-full list-none p-0 m-0">
