    ...
    >
      <div className="overflow-y-auto py-5 pt-14 sm:pt-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <ul className="space-y-2">
          <li>
            <NavItem link="/" icon="dashboard" text="Dashboard"/>
          </li>
          <li>
            ...
            <ul id="dropdown-pages" className="hidden py-2 space-y-2">
              <li>
                <NavItemDeep link="/profile" text="Profile"/>
              </li>
              <li>
                <NavItemDeep link="/price" text="Price"/>
              </li>
              <li>
                <NavItemDeep link="/docs" text="Docs"/>
              </li>
            </ul>
          </li>
        </ul>
        <ul className="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
          <li>
            <NavItem link="/ticket" icon="clipboard-list" text="Ticket"/>
          </li>
        </ul>
        <ul className="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
          <li>
            <NavItem link="/docs" icon="clipboard" text="Docs"/>
          </li>
        </ul>
      </div>
      <div className="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20 border-r border-gray-200 dark:border-gray-700">
        <Link to="/admin" data-tooltip-target="tooltip-admin" className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
        ...
        <Link to="/settings" data-tooltip-target="tooltip-settings" className="inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
