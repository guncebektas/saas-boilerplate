...
import {FaTimes} from "react-icons/fa"; // Import FaqForm
  ...
  return (
    <>
      <div className="flex items-center">
        ...
        <AddNewButton on={handleAddNew}/>
      </div>

      <DataGrid columns={columns} data={items} loading={loading} actions={actions}/>
      ...
      {drawerOpen && (
        <div className="fixed top-0 right-0 w-96 h-full bg-white dark:bg-gray-900 shadow-lg z-50 transition-transform duration-300 transform translate-x-0">
          ...
          <section className="p-5">
            <FaqForm _id={editId} closeDrawer={closeDrawer}/>
          </section>
        </div>
      )}
    </>
